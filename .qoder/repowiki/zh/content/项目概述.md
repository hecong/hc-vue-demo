...
- [src/layouts/MainLayout.vue:1-366](file://src/layouts/MainLayout.vue#L1-L366)
...
### 权限管理系统详解
- 权限模型：基于权限码的细粒度控制，支持用户、角色、权限三级关联
- 权限获取：通过系统API获取完整权限列表，初始化权限缓存
- 权限验证：路由守卫与组件内权限验证双重保障
- 角色管理：支持角色增删改查与权限分配
- 权限缓存：提供权限缓存初始化功能，提升系统性能
...
**章节来源**
- [src/views/dashboard/index.vue:1-413](file://src/views/dashboard/index.vue#L1-L413)
- [src/views/user/index.vue:1-377](file://src/views/user/index.vue#L1-L377)
